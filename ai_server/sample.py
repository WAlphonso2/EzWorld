...
def parse_description():
    ...
    return a JSON object with parameters required for generating terrain, including weather information. 
    ...
    WeatherGenerator:
    - Provide the `weatherType` string based on the user's input. Choose from:
        - "sunny" for minimal clouds
        - "rainy" for heavy clouds
        - "windy" for moderate clouds
        - "stormy" for maximum clouds and storm effect
    ...
    try:
        ...
        structured_response = {
            ...
            "grassGenerator": {
                ...
                "weatherType": terrain_data.get("weatherGenerator", {}).get("weatherType", "sunny")  # Default to sunny
            }
    }
