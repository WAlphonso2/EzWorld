...
public class CharacterSelectionManager : MonoBehaviour
{
    ...
    private void PositionPlayerNearPath()
    {
        ...
        if (worldInfo.cityData != null && terrainGenerator.cityGenerator != null && terrainGenerator.cityGenerator.citySpawnPoint != null)
        {
            // Use the city's spawn point if available
            currentCharacter.transform.position = terrainGenerator.cityGenerator.citySpawnPoint.position;
            Debug.Log("Player positioned at city spawn point: " + currentCharacter.transform.position);
        }
        else
        {
            // Fall back to spawning near the path
            ...
            Debug.Log("Player positioned at path: " + currentCharacter.transform.position);
        }
    }
